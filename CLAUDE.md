...
- Глобальные изменения функционала (команды, модули, сервисы, зависимости, архитектура, runtime, env) → обнови README + AGENTS.md тем же скиллом, включая пересчёт LoC
